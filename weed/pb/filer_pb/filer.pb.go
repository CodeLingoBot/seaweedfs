...
It has these top-level messages:
	...
	ListFilerClientsRequest
	ListFilerClientsResponse
*/
package filer_pb
...
type ListFilerClientsRequest struct {
	ClientType string `protobuf:"bytes,1,opt,name=client_type,json=clientType" json:"client_type,omitempty"`
}

func (m *ListFilerClientsRequest) Reset()                    { *m = ListFilerClientsRequest{} }
func (m *ListFilerClientsRequest) String() string            { return proto.CompactTextString(m) }
func (*ListFilerClientsRequest) ProtoMessage()               {}
func (*ListFilerClientsRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{30} }

func (m *ListFilerClientsRequest) GetClientType() string {
	if m != nil {
		return m.ClientType
	}
	return ""
...
type ListFilerClientsResponse struct {
	GrpcAddresses []string `protobuf:"bytes,1,rep,name=grpc_addresses,json=grpcAddresses" json:"grpc_addresses,omitempty"`
}

func (m *ListFilerClientsResponse) Reset()                    { *m = ListFilerClientsResponse{} }
func (m *ListFilerClientsResponse) String() string            { return proto.CompactTextString(m) }
func (*ListFilerClientsResponse) ProtoMessage()               {}
func (*ListFilerClientsResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{31} }

func (m *ListFilerClientsResponse) GetGrpcAddresses() []string {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*ListFilerClientsRequest)(nil), "filer_pb.ListFilerClientsRequest")
	proto.RegisterType((*ListFilerClientsResponse)(nil), "filer_pb.ListFilerClientsResponse")
}
...
type SeaweedFilerClient interface {
	...
	ListFilerClients(ctx context.Context, in *ListFilerClientsRequest, opts ...grpc.CallOption) (*ListFilerClientsResponse, error)
}
...
func (c *seaweedFilerClient) ListFilerClients(ctx context.Context, in *ListFilerClientsRequest, opts ...grpc.CallOption) (*ListFilerClientsResponse, error) {
	out := new(ListFilerClientsResponse)
	err := grpc.Invoke(ctx, "/filer_pb.SeaweedFiler/ListFilerClients", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SeaweedFilerServer interface {
	...
	ListFilerClients(context.Context, *ListFilerClientsRequest) (*ListFilerClientsResponse, error)
}
...
func _SeaweedFiler_ListFilerClients_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListFilerClientsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SeaweedFilerServer).ListFilerClients(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/filer_pb.SeaweedFiler/ListFilerClients",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SeaweedFilerServer).ListFilerClients(ctx, req.(*ListFilerClientsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _SeaweedFiler_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListFilerClients",
			Handler:    _SeaweedFiler_ListFilerClients_Handler,
		},
	},
...
var fileDescriptor0 = []byte{
	...
	,
}
